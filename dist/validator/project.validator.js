...
export const schema = joi.object({
    ...
    techStack: joi.array().items(techStackSchema).required().messages({
        ...
        "array.includesRequiredUnknowns": "Tech stack must be an array of objects with id, label, and value."
    }),
    ...
    category: joi
        .string()
        .valid("Technology", "Education", "Health and Fitness", "Art", "Finance", "Social Networking", "Software Development", "Science and Research", "Environmental and Sustainability", "Entertainment and Media", "Gaming", "Non-Profit and Community", "Travel and Hospitality", "Agriculture and Food", "Retail and E-commerce", "Legal and Governance", "Others")
        .required()
        .messages({
